...
url = "data/weather_temperature_kualanamo.csv"
...
plt.ylabel("Temperature_Avr")
plt.xlabel("Day")
plt.title("All data of Kualanamu (96035) Station 2008-2020")
...
plt.ylabel("Temperature_Avr 2008-2020")
plt.xlabel("Day")
